          ...
          <div class="table-box">
            ...
            <div class="pull-left">
              <div class="form-group form-inline">
                <div class="btn-group">
                  <button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/pages/add-course.jsp'">
                    <i class="fa fa-file-o"></i> 新建
                  </button>
                  <button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/pages/update-course.jsp'">
              ...
              <c:forEach items="${courseList}" var="cList" >
                <tr>
                  ...
                  <td class="text-center">
                    <a href="${pageContext.request.contextPath}/manager/deletecourse.do?courseid=${cList.courseid}" class="btn bg-olive btn-xs">删除</a>
                  </td>

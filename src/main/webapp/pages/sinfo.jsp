...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="${pageContext.request.contextPath}/student/updateinfo.do"
          method="post">
      <!-- 正文区域 -->
          ...
          <div class="row data-type">
            ...
            <div class="col-md-4 data">
              <input type="text" class="form-control" name="ssex"
                     placeholder="${student.ssex}" value="${student.ssex}">
            </div>
            ...
            <div class="col-md-4 data">
              <input type="text" class="form-control" name="cid"
                     placeholder="${student.cid}" value="${student.cid}">
            </div>
            <div class="col-md-2 title">状态</div>
            <div class="col-md-4 data">
              <input type="text" class="form-control" name="sstatus"
                     placeholder="${student.sstatus}" value="${student.sstatus}">
            </div>
            <div class="col-md-2 title">电话</div>
            <div class="col-md-4 data">
              <input type="text" class="form-control" name="phone"
                     placeholder="${student.phone}" value="${student.phone}">
            </div>
            <div class="col-md-2 title">地址</div>
            <div class="col-md-4 data">
              <input type="text" class="form-control" name="address"
                     placeholder="${student.address}" value="${student.address}">
            </div>
            <div class="col-md-2 title">邮箱</div>
            <div class="col-md-4 data">
              <input type="text" class="form-control" name="email"
                     placeholder="${student.email}" value="${student.email}">
            </div>
            <div class="col-md-2 title">密码</div>
            <div class="col-md-4 data">
              <input type="text" class="form-control" name="pwd"
                     placeholder="输入新密码" value="${student.pwd}">
            </div>
            <div class="col-md-2 title">入学时间</div>
            <div class="col-md-4 data">
              <input type="text" class="form-control" name="entime"
                     placeholder="${student.entime}" value="${student.entime}">
            </div>
          </div>
